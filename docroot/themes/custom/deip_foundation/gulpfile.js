...
// Build everything.
gulp.task('build', ['sass', 'drush:cr', 'lint']);
...
gulp.task('watch:css', ['sass', 'drush:cr', 'lint:sass'], function () {
  return gulp.watch(options.theme.scss + '**/*.scss', options.gulpWatchOptions, ['sass', 'drush:cr', 'lint:sass']);
});
