...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_prod_eemmcdowell_dev_default.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_prod_eemmcdowell_dev_default.inc';
}
// </DDSETTINGS>
$databases['default']['default'] = array (
  'database' => 'local_eemmcdowell',
  'username' => 'root',
  'password' => '',
  'prefix' => '',
  'host' => '127.0.0.1',
...
$config_directories['sync'] = 'sites/local.eemmcdowell.dd/files/config_BSudS39q23ZB6JH6akbh_Cnhj-pEHnzgyH1UAhPMFdNebsQBbTrSOG1arRZ9sA6iF_J4W27bIQ/sync';
