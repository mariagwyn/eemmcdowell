 ...
 * @endcode
 */
$settings['hash_salt'] = '5kg5kDkKe-4u1vrLYmytyPchlK_CAabTgfJBBBR7Q8HZbH7kJP1pP7FsmFF1j2bQWiTFwsVYbw';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_prod_eemmcdowell_dev_local_mtm.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_prod_eemmcdowell_dev_local_mtm.inc';
}
// </DDSETTINGS>
$databases['default']['default'] = array (
  'database' => 'local_mtm_active',
  'username' => 'root',
  'password' => '',
  'prefix' => '',
  'host' => '127.0.0.1',
...
$config_directories['sync'] = 'sites/local.mtm.dd/files/config_BcBfCrmJPSTx2_eE3wUSraRwdrvRIh6b2mEdi0r7SG4qHQsdbWgUL3bnw7mMI18BjUneol1wtw/sync';
