...
class UninstallDefaultContentTest extends BrowserTestBase {
  ...
  public function testReinstall() {
    ...
    $module_installer->uninstall(['mariagwyn_content']);
    ...
    $module_installer->install(['mariagwyn_content']);
    $this->assertRecipesImported($node_storage);
  ...
  protected function assertArticlesImported(EntityStorageInterface $node_storage) {
    $count = $node_storage->getQuery()
      ...
      ->execute();
    $this->assertGreaterThan(0, $count);
    $nodes = $node_storage->loadByProperties(['title' => 'The mariagwyn guide to our favorite mushrooms']);
    $this->assertCount(1, $nodes);
    $node = reset($nodes);
  ...
  protected function expectedBlocks() {
    return [
      [
        ...
        'image_css_selector' => '#block-mariagwyn-banner-home img',
      ...
      [
        ...
        'image_css_selector' => '#block-mariagwyn-banner-recipes img',
      ...
      [
        ...
        'image_css_selector' => '#block-mariagwyn-footer-promo img',
        'image_alt_text' => '3 issue bundle of the MariaGwyn food magazine',
      ],
    ];
  }
