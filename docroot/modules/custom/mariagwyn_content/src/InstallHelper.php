...
namespace Drupal\mariagwyn_content;
 ...
 *
 * @internal
 *   This code is only for use by the MariaGwyn demo: Content module.
 */
class InstallHelper implements ContainerInjectionInterface {
  ...
  protected function getModulePath() {
    $this->module_path = $this->moduleHandler->getModule('mariagwyn_content')->getPath();
    return $this;
  }
  ...
  public function deleteImportedContent() {
    $uuids = $this->state->get('mariagwyn_content_uuids', []);
  ...
  protected function storeCreatedContentUuids(array $uuids) {
    $uuids = $this->state->get('mariagwyn_content_uuids', []) + $uuids;
    $this->state->set('mariagwyn_content_uuids', $uuids);
  }
