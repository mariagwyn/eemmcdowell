...
/**
 * Tests demo_mariagwyn profile.
 *
 * @group demo_mariagwyn
 */
class DemoMariaGwynProfileTest extends BrowserTestBase {
  ...
  /**
   * Tests demo_mariagwyn profile warnings shown on Status Page.
   */
  ...
  public function testConfig() {
    ...
    $default_config_storage = new FileStorage(drupal_get_path('profile', 'demo_mariagwyn') . '/' . InstallStorage::CONFIG_INSTALL_DIRECTORY, InstallStorage::DEFAULT_COLLECTION);
    $this->assertDefaultConfig($default_config_storage, $active_config_storage);

    $default_config_storage = new FileStorage(drupal_get_path('profile', 'demo_mariagwyn') . '/' . InstallStorage::CONFIG_OPTIONAL_DIRECTORY, InstallStorage::DEFAULT_COLLECTION);
    $this->assertDefaultConfig($default_config_storage, $active_config_storage);
  }
  ...
  /**
   * Tests that the MariaGwyn theme is available on the Appearance page.
   */
  public function testAppearance() {
    ...
    $webassert->pageTextContains('MariaGwyn');
  }
